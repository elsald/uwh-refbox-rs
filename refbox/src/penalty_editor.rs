...
use uwh_common::game_snapshot::{Color, FoulKind};
...
impl PenaltyEditor {
    ...
    pub fn apply_changes(&mut self, now: Instant) -> Result<()> {
        ...
        let mut new_pens: Vec<(Color, PenaltyKind, u8, FoulKind)> = vec![];
...
mod test {
    ...
    fn test_add_penalty() {
        ...
        assert_eq!(
            pen_edit.add_penalty(Color::Black, 4, PenaltyKind::OneMinute, FoulKind::Unknown),
